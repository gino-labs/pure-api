...
class FBGet:
    ...
    def get_alert_watchers(self, **params):
        return self._request("alert-watchers", params=params)
    ...
    def get_bucket_replica_links(self, **params):
        return self._request("bucket-replica-links", params=params)
                
    def get_buckets(self, **params):
        return self._request("buckets", params=params)
    ...
    def get_certificates(self, **params):
        return self._request("certificates", params=params)
    ...
    def get_dns(self, **params):
        return self._request("dns", params=params)
       
    def get_filesystem_replica_links(self, **params):
        return self._request("file-system-replica-links", params=params)
        
    def get_filesystem_snapshots(self, **params):
        return self._request("file-system-snapshots", params=params)
    ...
    def get_object_store_access_keys(self, **params):
        return self._request("object-store-access-keys", params=params)
    ...
    def get_object_store_remote_credentials(self, **params):
        return self._request("object-store-remote-credentials", params=params)
    
    def get_object_store_users(self, **params):
        return self._request("object-store-users", params)
        
    def get_network_interfaces(self, params):
        return self._request("network-interfaces", params=params)
    
    def get_nfs_export_policies(self, **params):
        return self._request("nfs-export-policies", params=params)
    
    def get_quotas_groups(self, **params):
        return self._request("quotas/groups", params=params)    
    
    def get_quotas_settings(self, **params):
        return self._request("quotas/settings", params=params)
        
    def get_quotas_users(self, **params):
        return self._request("quotas/users", params=params)
    ...
    def get_smb_client_policies(self, **params):
        return self._request("smb-client-policies", params=params)
      
    def get_smb_share_policies(self, **params):
        return self._request("smb-share-policies", params=params)
        
    def get_smtp_servers(self, **params):
        return self._request("smtp-servers", params=params)
        
    def get_snapshot_policies(self, **params):
        return self._request("policies", params=params)
    ...
    def get_subnets(self, **params):
        return self._request("subnets", params=params)

    def get_syslog_servers(self, **params):
        return self._request("syslog-servers", params=params)

    def get_usage_groups(self, **params):
        return self._request("usage/groups", params=params)
           
    def get_usage_users(self, **params):
        return self._request("usage/users", params=params)
