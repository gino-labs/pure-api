...
class FBPost:
    ...
    def _post_request(self, endpoint: str, params=None, json=None, only_items=True):
    ...
    def post_bucket_replica_links(self, names: str, remote_credential_names: str, json=None, **params):
        ...
        return self._post_request("bucket-replica-links", json=json, params=params)
                
    def post_buckets(self, names: str, json=None, **params):
        params["names"] = names
        return self._post_request("buckets", json=json, params=params)
    
    def post_certificates(self, names, json=None, **params):
        params["names"] = names
        return self._post_request("certificates", json=json, params=params)
    ...
    def post_certificates_to_groups(self, certificate_names: str, certificate_group_names: str, json=None, **params):
        ...
        return self._post_request("certificate-groups/certificates", json=json, params=params)
           
    def post_connection_key(self):
        return self._post_request("array-connections/connection-key")
    ...
    def post_filesystem_policies(self, filesystem_names: str, policy_names: str, json=None, **params):
        ...
        return self._post_request("file-systems/policies", json=json, params=params)
    ...
    def post_filesystem_replica_links(self, names: str, remote_names: str, json=None, **params):
        ...
        return self._post_request("file-system-replica-links", json=json, params=params)
    ...
    def post_filesystem_snapshots(self, names: str, replication=True, json=None, **params):
        ...
        if replication:
            ...
            params["names"] = names
        return self._post_request("file-system-snapshots", json=json, params=params)
                    
    def post_filesystems(self, names: str, json=None, **params):
        params["names"] = names
        return self._post_request("file-systems", json=json, params=params)
            
    def post_nfs_export_policies(self, names, json=None, **params):
        params["names"] = names
        return self._post_request("nfs-export-policies", json=json, params=params)
            
    def post_network_interfaces(self, names: str, json=None, **params):
        params["names"] = names
        return self._post_request("network-interfaces", json=json, params=params)
                
    def post_object_store_access_keys(self, names: str, json=None, **params):
        params["names"] = names
        return self._post_request("object-store-access-keys", json=json, params=params)   
        
    def post_object_store_accounts(self, names: str, json=None, **params):
        params["names"] = names
        return self._post_request("object-store-accounts", json=json, params=params)
 
    def post_object_store_users(self, names: str, json=None, **params):
        params["names"] = names
        return self._post_request("object-store-users", json=json, params=params)

    def post_object_store_remote_credentials(self, names: str, json=None, **params):
        params["names"] = names
        return self._post_request("object-store-remote-credentials", json=json, params=params)
    
    def post_policies(self, names, json=None, **params):
        params["names"] = names
        return self._post_request("policies", json=json, params=params)
        
    def post_subnets(self, names: str, json=None, **params):
        params["names"] = names
        return self._post_request("subnets", json=json, params=params)  

    def post_syslog_servers(self, names, json=None, **params):
        params["names"] = names
        return self._post_request("syslog-servers", json=json, params=params) 
